...
const Cart = () => {
    ...
    const cartValue = cart ? cart.map((cartItem: CartItemInterface) => cartItem.quantity * cartItem.price).reduce((total: number, currentNumber: number) => total + currentNumber, 0) : 0
