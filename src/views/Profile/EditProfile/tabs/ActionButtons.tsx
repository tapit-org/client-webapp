...
const ActionButtonCard = ({ item, setItem, toggleItem }) => {
    return <Paper elevation={1} className="my-2 mx-0 p-5 w-full">
        <Stack
            direction="row"
            alignItems="center"
            spacing={2}
...
const ActionButtons = ({
    ...
    const handleSetActionButton = (id: string, text: string) => {
        setActionButtons((actionButtons: any) => {
            return actionButtons.map((actionButton: any) => {
    ...
    return (
        <div>
            <DraggableList items={actionButtons} setItems={setActionButtons}>
