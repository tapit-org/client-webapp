...
import AccordionInfo from 'views/ProductDetail/AccordionInfo';
...
import ModalViewAllReviews from 'views/ProductDetail/ModalViewAllReviews';
		...
		return (
			<div className="">
				...
				<div className="prose prose-sm sm:prose dark:prose-invert sm:max-w-4xl mt-7">
					<p>
						The patented eighteen-inch hardwood Arrowhead deck --- finely mortised in,
						makes this the strongest and most rigid canoe ever built. You cannot buy a
						canoe that will afford greater satisfaction.
					</p>
					<p>
					...
					<ul>
						...
						<li>
							Quality cotton grown without the use of herbicides or pesticides - GOTS
							certified
						</li>
