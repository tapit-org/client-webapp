...
export interface Product {
	...
	sizes?: string[];
	allOfSizes?: string[];
	status?: 'New in' | 'limited edition' | 'Sold Out' | '50% Discount' | 'Customizable Design';
}
...
const METAL_CARD_VARIANTS: ProductVariant[] = [
	{
		id: 1,
		name: 'Silver',
		color: 'bg-silver-400',
...
export const PRODUCTS: Product[] = [
	{
		id: 1,
		name: 'Metal Cards',
		description: 'Premium Metal Cards',
		price: 1999,
		image: productSport6,
		category: 'Card',
		tags: ['Metal', 'Business Card'],
		variantType: 'color',
		variants: METAL_CARD_VARIANTS,
		link: '/product-detail/',
